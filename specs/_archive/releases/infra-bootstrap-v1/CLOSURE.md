...
|-------------|---------|----------|
| Release implementada e mergeada antes de 2026-05-17 | `git log --first-parent -- specs/features/infra-bootstrap-v1/ specs/features/infra-bootstrap/` | Commits em `main` anteriores a 2026-05-17 |
| SPEC, PLAN, TASKS preservados no archive | `ls specs/_archive/releases/infra-bootstrap-v1/` | `SPEC.md PLAN.md TASKS.md` presentes |
...
**MOVE** — diretório relocado para `specs/_archive/releases/infra-bootstrap-v1/` durante a
