...
|-------------|---------|----------|
| Release implementada e mergeada antes de 2026-05-17 | `git log --first-parent -- specs/features/content-json-v1/ specs/features/content-json/` | Commits em `main` anteriores a 2026-05-17 |
| SPEC, PLAN, TASKS preservados no archive | `ls specs/_archive/releases/content-json-v1/` | `SPEC.md PLAN.md TASKS.md` presentes |
...
**MOVE** — diretório relocado para `specs/_archive/releases/content-json-v1/` durante a
