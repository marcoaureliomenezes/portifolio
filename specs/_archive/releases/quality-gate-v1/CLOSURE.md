...
|-------------|---------|----------|
| Release implementada e mergeada antes de 2026-05-17 | `git log --first-parent -- specs/features/quality-gate-v1/ specs/features/quality-gate/` | Commits em `main` anteriores a 2026-05-17 |
| SPEC, PLAN, TASKS preservados no archive | `ls specs/_archive/releases/quality-gate-v1/` | `SPEC.md PLAN.md TASKS.md` presentes |
...
**MOVE** — diretório relocado para `specs/_archive/releases/quality-gate-v1/` durante a
