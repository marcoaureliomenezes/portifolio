# ==============================================================================
# CloudFront — distribuicao CDN com HTTPS e SPA fallback
# ==============================================================================

resource "aws_cloudfront_origin_access_control" "website" {
  name                              = "${local.domain}-oac"
  description                       = "OAC para ${local.domain}"
...
resource "aws_cloudfront_distribution" "website" {
  ...
  comment             = "CloudFront distribution para ${local.domain}"
  default_root_object = "index.html"

  # prod: apex + www; stage: apenas o subdominio
